...
// 商品の定義
let itemList = [
    { id: '0001', name: 'ソファベッド', tags: ['ベッド', 'ソファ', '寝具'], price: 20000 },
    { id: '0002', name: 'シングルベッド', tags: ['ベッド', 'ソファ', '寝具'], price: 15000 },
    { id: '0003', name: '子ども用ベッド', tags: ['ベッド', 'ソファ', '寝具', '子ども部屋家具'], price: 10000 },
    { id: '0004', name: 'ソファ', tags: ['ソファ'], price: 25000 },
    { id: '0005', name: 'キューブボックス', tags: ['家具・ラック', '収納システム'], price: 5000 },
    { id: '0006', name: 'オープンラック', tags: ['家具・ラック', '収納システム'], price: 7000 },
    { id: '0007', name: 'コンピュータデスク', tags: ['テーブル・椅子'], price: 10000 },
    { id: '0008', name: 'サイドテーブル', tags: ['テーブル・椅子'], price: 3000 },
    { id: '0009', name: 'ダイニングテーブル', tags: ['テーブル・椅子'], price: 20000 },
    { id: '0010', name: '子ども部屋用収納', tags: ['収納システム', '子ども部屋家具'], price: 8000 },
    { id: '0011', name: 'テフロンフライパン', tags: ['フライパン'], price: 2500 },  // 新しく追加
    { id: '0012', name: '三徳包丁', tags: ['包丁'], price: 3000 },                 // 新しく追加
    { id: '0013', name: '抗菌まな板', tags: ['まな板'], price: 1200 }             // 新しく追加
];
...
function setSubMenu(idx) {
    ...
    // 大分類の配列に保存されている数だけoptionとして追加する
    cate2[idx].forEach(subCategory => {
        // option要素を新規に作成
        let option = document.createElement('option');
        option.value = subCategory;    // optionの値に配列の値を代入
        option.text = subCategory;     // optionの表示文字列に配列の値を代入
...
function viewItemList(tag) {
    ...
    itemList.filter(item => item.tags.includes(tag)).forEach(item => {
        // li要素を作成
